...
hl.window_rule({match = {class = "^(org\\.quickshell)$", title = "^(System Settings)$" }, float = true})
hl.window_rule({match = {class = "^(org\\.quickshell)$", title = "^(System Settings)$" }, size = {740, 932}})
hl.window_rule({match = {class = "^(org\\.quickshell)$", title = "^(System Settings)$" }, center = true})
...
hl.layer_rule({ match = { namespace = "quickshell:macosDock" }, animation = "slide bottom"})
