...
install-local-pkgbuild() {
  ...
  # -c, --clean: Clean up leftover src/ and pkg/ directories after a successful build.
...
metapkgs=(./sdata/dist-arch/illogical-impulse-{apps,audio,backlight,basic,fonts-themes,kde,portal,python,screencapture,toolkit,widgets})
